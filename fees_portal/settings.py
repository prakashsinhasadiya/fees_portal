"""
Django settings for fees_portal project.
...
SECRET_KEY = 'k3dtg1xn%@j1zh65^1uv&=90!pkf(%71#=5*q&fs9=jo1^!*k@'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'logfile': {
            ...
            'filename': "/home/prakash/Django/fees_portal" + "/prakash_log",
            'maxBytes': 50000,
            'backupCount': 2,
            'formatter': 'standard',
        },
